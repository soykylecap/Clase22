...
class Articulos(models.Model):
    ...
    def __str__(self):
        return f"{self.id} || {self.producto} || Precio: {self.precio}"
...
class Gastos(models.Model):
    ...
    def __str__(self):
        return f"{self.id} || {self.fecha} | {self.detalle} | {self.area} | {self.importe}"
...
class Clientes(models.Model):
    ...
    def __str__(self):
        return f"{self.id} || {self.nombre} {self.apellido} || Email: {self.email}"
